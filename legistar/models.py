...
class Event:
    ...
    def from_dict(obj: Any) -> "Event":
        ...
        agenda_last_published_utc = from_datetime(
            obj.get("EventAgendaLastPublishedUTC")
        )
        minutes_last_published_utc = from_datetime(
            obj.get("EventMinutesLastPublishedUTC")
        )
